...
// using Microsoft.ML.Transforms.Onnx; // Uncomment after verifying environment
using Microsoft.ML;
using System.IO;
...
public class ImageClassificationPipeline
{
    ...
    public static IEstimator<ITransformer> BuildTrainingPipeline(string onnxModelPath)
    {
        var pipeline = Context.Transforms.Conversion
            ...
            //     outputColumnName: "BottleneckFeatures",
            //     inputColumnName: "Image",
            //     modelFile: onnxModelPath));
            // Add ONNX feature extraction after environment validation
